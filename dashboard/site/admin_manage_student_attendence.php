...
if (isset($_POST['submit_attendance_information'])) {
	$islogin=1;
	$class=$_POST['class'];
	$section=$_POST['section'];
	$attendance_date=$_POST['attendance_date'];
	$sql_for_show_student="SELECT * FROM admin_student WHERE class='$class' AND section='$section'";
...
<!-- 					<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							<h3 class="widget-title">take addendance</h3>
							<!-- add class-->
							<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">add attendance</button>
								      ...
								      <div class="modal-content">
								        <div class="modal-header">
								         <!--  <button type="button" class="close" data-dismiss="modal">&times;</button> -->
								          <h4 class="modal-title">student attendence</h4>
								        </div>
								        ...
								        <div class="modal-body">
								           <label>class:</label>
										        ...
										        <input id="date" type="date" name="attendance_date" value="2017-06-01">
								          <input type="submit" name="submit_attendance_information">
								        </div>
								        </form>
							...
							<div class="table-responsive">
								<table class="table">
									<?php
                                     if ($islogin==1) {
                                     	//when input class and section name then open it..
								...
								?>
										...
										<tr>
											<td><?php echo $row_for_show_student['first_name'];?></td>
											<td><?php echo $row_for_show_student['class'];?></td>
											<td><?php echo $row_for_show_student['section'];?></td>
											<td> <?php echo $attendance_date;?></td>
											<td>
												<label class="checkbox-inline"><input type="checkbox" value="Present" name="present" checked="">Present</label>
												<label class="checkbox-inline"><input type="checkbox" value="Absent" name="present">Absent</label>
												<label class="checkbox-inline"><input type="checkbox" value="late" name="present">late</label>
											</td>
											
											<?php
											//show student end tag below here...
										     }
										     ?>
										     <td><input type="submit" name="student_present_submit"></td>
										</form>

										</tr>
									</tbody>
								<?php
								//islogin end below tag...
								  }
								?>	
								</table>
							</div>
