				...
				<div class="row">
					...
					<div class="col-md-12" >
						<div class="widget-area-2 lorvens-box-shadow">
							<h3 class="widget-title">add course</h3>
								...
								<table class="table" id="myScrollspy">
									...
									<form method="post" action="" enctype="multipart/form-data">
										<tr>
											...
											<td>
												 <input type="text" name="title" class="form-control" style="width: 100px;" value="<?php echo $title;?>">
											</td>
											<td>
												 <input type="text" name="description" class="form-control" style="width: 100px;" value="<?php echo $description ?>">
											</td>
											...
											<td>
												<button type="submit" name="update_course_info" class="btn btn-success">update</button>
											</td>
										</tr>
									</form>	
									</tbody>
								...
								<tbody>
									<form method="post" action="" enctype="multipart/form-data">
										<tr>
											...
											<td>
												 <input type="text" name="description" class="form-control" style="width: 100px;">
											</td>
											<td>
												<button type="submit" name="submit_course" class="btn btn-success">submit</button>
											</td>
										</tr>
									</tbody>
									</form> 	
                                    ...
                                    <tbody>
										<tr>
											<td>
												<img src="../../uploads/<?php echo $row_for_show_course['image']?>" class="img-responsive" alt="Cinque Terre" width="100" height="50">
											</td>
											<td>
												<?php echo $row_for_show_course['title']?>
												<input type="hidden" name="title" value="<?php echo $row_for_show_course['title']?>">
											</td>
											<td>
												<?php echo $row_for_show_course['description']?>
												<input type="hidden" name="description" value="<?php echo $row_for_show_course['description']?>">
											</td>
											
											<td>
												 <input type="hidden" name="course_id" value="<?php echo $row_for_show_course['id']?>">
											</td>
											<td>
												<button type="submit" class="btn btn-danger" name="delete_course">delete</button>
												<button type="submit" class="btn btn-warning" name="update_course">update</button>
