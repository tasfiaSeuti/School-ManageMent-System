		...
		<div id="content">
			...
			<div class="container-fluid home">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							<h3 class="widget-title">Approved student</h3>
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td>
                                             <?php echo $row_for_student_register['st_email']?>
											</td>
											<td>
												<?php echo $row_for_student_register['father_name']?>
											</td>
											<td>
												<?php echo $row_for_student_register['mother_name']?>
											</td>
											<td>
												<?php echo $row_for_student_register['present_address']?>
											</td>
											<td>
												<?php echo $row_for_student_register['permanent_name']?>
											</td>
											<?php $approve=$row_for_student_register['approved'];
                                            if ($approve=='yes') {?>
											<td>
												<button type="submit" class="btn btn-danger" name=" ">approved</button>
											</td>
                                            <?php 
                                             }
                                             else
                                            ...
                                            <td>
												...
												<button type="submit" class="btn btn-warning" name="approved_submit">approve</button>
