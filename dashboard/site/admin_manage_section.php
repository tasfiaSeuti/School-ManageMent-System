...
if (isset($_POST['update_section_info'])) {
  ...
  $teacher_name=$_POST['teacher_name'];
  $section_id=$_POST['section_id'];
  $editQuery = "UPDATE admin_manage_section SET class_name='$class_name', section_name='$section_name', teacher_name='$teacher_name' WHERE id=$section_id";
...
if (isset($_POST["submit_section"])) {
	...
	$teacher_name=$_POST["teacher_name"];
	$section_name=$_POST['section_name'];
	$sql_for_admin_add_section="INSERT INTO admin_manage_section VALUES ('','$class_name','$section_name','$teacher_name')";
          $result_for_admin_add_section=$con->query($sql_for_admin_add_section);
          if($result_for_admin_add_section){
        echo "insert";
...
<!-- 					<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							<h3 class="widget-title">manage section</h3>
							<!-- add section-->
							<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">add section</button>
								    ...
								    <div class="modal-dialog">
								      ...
								      <div class="modal-content">
                                        ...
                                        ?>
								          ...
								          <input type="submit" name="submit_section">
								        </div>
								        </form>
								...
								<table class="table">
									...
									<form method="post" action="">
										<tr>
											...
											<td>
												 <input type="text" name="section_name" class="form-control" style="width: 100px;" value="<?php echo $section_name ?>">
											</td>
											<td>
											...
											<td>
												<button type="submit" name="update_section_info" class="btn btn-success">update</button>
											</td>
											<td>
									...
									<tbody>
										...
										<tr>
											<td>
												...
												<?php echo $row_for_show_section['class_name']?>
												
											</td>
											<td>
												
												<?php echo $row_for_show_section['section_name']?>
													
											</td>
											
											<td>
												
												<?php echo $row_for_show_section['teacher_name']?>
													
											</td>
											
											<td>
												<button type="submit" class="btn btn-danger" name="delete_section">delete</button>
												<button type="submit" class="btn btn-warning" name="update_section">update</button>
											</td>
											<td>
												<input type="hidden" name="section_id" value="<?php echo $row_for_show_section['id']?>">
												<input type="hidden" name="class_name" value="<?php echo $row_for_show_section['class_name']?>">
												<input type="hidden" name="section_name" value="<?php echo $row_for_show_section['section_name']?>">
												<input type="hidden" name="teacher_name" value="<?php echo $row_for_show_section['teacher_name']?>">
											</td>
