...
if (isset($_POST['update_subject_info'])) {
  ...
  $total_mark=$_POST['total_mark'];
  $subject_id=$_POST['subject_id'];
  $editQuery = "UPDATE admin_manage_subject SET class_name='$class_name', subject_name='$subject_name', teacher_name='$teacher_name', total_mark='$total_mark' WHERE id=$subject_id";
...
if (isset($_POST["submit_subject"])) {
	...
	$subject_name=$_POST['subject_name'];
	$total_mark=$_POST['total_mark'];
	$sql_for_admin_add_subject="INSERT INTO admin_manage_subject VALUES ('','$class_name','$teacher_name','$subject_name','$total_mark')";
          $result_for_admin_add_subject=$con->query($sql_for_admin_add_subject);
          if($result_for_admin_add_subject){
        echo "insert";
...
?>
<?php
$sql_for_show_subject="SELECT * FROM admin_manage_subject";
...
<!-- 					<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							<h3 class="widget-title">manage subject</h3>
							<!-- add section-->
							<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">add subject</button>
								    ...
								    <div class="modal-dialog">
								      ...
								      <div class="modal-content">
								        ...
								        ?>
								          ...
								          <input type="text" name="total_mark" placeholder="Total mark"></br>
								          <label>teacher:</label>	
                                          <select name="teacher_name">
                                          	<?php
								        	//show teacher name in database
								        	...
								        	?>
								          	...
								          	<option><?php echo $row_for_show_teacher['name'];?></option></br>
								          	 <?php
								        //end show teacher name in database...
								         }
                                        $i++;
                                        ?>
								          </select>
                                          ...
                                          <select name="subject_name">
                                          	<?php
								        	//show subject name in database

											$sql_for_show_subject_show="SELECT * FROM subject";
											$result_for_show_subject_show=$con->query($sql_for_show_subject_show);
											
                                              while ($row_for_show_subject_show= $result_for_show_subject_show->fetch_assoc()) {

								        	?>
								        	
								          	<option><?php echo $row_for_show_subject_show['subject_name'];?></option></br>
								          	 <?php
                                        ...
                                        ?>
								          ...
								          <input type="submit" name="submit_subject">
								        </div>
								        </form>
								...
								<table class="table">
									...
									<form method="post" action="">
										<tr>
											...
											<td>
												<input type="text" name="teacher_name" class="form-control" style="width: 100px;" value="<?php echo $teacher_name ?>">
												
											</td>
											<td>
												 <input type="text" name="subject_name" class="form-control" style="width: 100px;" value="<?php echo $subject_name ?>">
											</td>
											<td>
												 <input type="text" name="total_mark" class="form-control" style="width: 100px;" value="<?php echo $total_mark ?>">
											</td>
											
											
											<td>
												<button type="submit" name="update_subject_info" class="btn btn-success">update</button>
											</td>
											<td>
									...
									<tbody>
										...
										<tr>
											<td>
												...
												<?php echo $row_for_show_subject['class_name']?>
												
											</td>
											<td>
												
												<?php echo $row_for_show_subject['teacher_name']?>
											...
											<td>
												...
												<?php echo $row_for_show_subject['total_mark']?>
													
											</td>
											
											<td>
												<button type="submit" class="btn btn-danger" name="delete_section">delete</button>
												<button type="submit" class="btn btn-warning" name="update_subject">update</button>
											</td>
											<td>
												<input type="hidden" name="subject_id" value="<?php echo $row_for_show_subject['id']?>">
												<input type="hidden" name="class_name" value="<?php echo $row_for_show_subject['class_name']?>">
												<input type="hidden" name="subject_name" value="<?php echo $row_for_show_subject['subject_name']?>">
												<input type="hidden" name="teacher_name" value="<?php echo $row_for_show_subject['teacher_name']?>">
												<input type="hidden" name="total_mark" value="<?php echo $row_for_show_subject['total_mark']?>">
											</td>
