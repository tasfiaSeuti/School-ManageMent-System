<?php
	...
	//sql query select all data from admin teacher..    
	$sql_for_teacher = "SELECT * FROM admin_teacher";
	//sql result query..
	$result_for_teacher = $con->query($sql_for_teacher);
...
<!-- Mirrored from kodeforest.net/html/uoe/our-teacher.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 May 2018 08:06:58 GMT -->
<head>
	<meta charset="utf-8">
    ...
    <div id="sidr">
    	...
    	<div class="kf_content_wrap">
    		<section class="edu2_teachers_page">
    			...
    			<!--show data from database all teacher show...-->

                    <?php  
			          $i = 1;
			            while ($row_for_teacher= $result_for_teacher->fetch_assoc()) {
    				...
    				<div class="row">
    					...
    					<div class="col-lg-3 col-md-4 col-sm-6">
							...
							<div class="edu2_faculty_des">
								<figure><img src="uploads/<?php echo $row_for_teacher['image'];?>" alt=""/>
									<figcaption>
								...
								<div class="edu2_faculty_des2">
									<h6><a href="#"><?php echo $row_for_teacher['name'];?></a></h6>
									<strong><?php echo $row_for_teacher['profession'];?></strong>
									<p><?php echo $row_for_teacher['details'];?></p>
								</div>
							</div>
							<!-- FACULTY DES END-->
    					</div>
...
<!-- Mirrored from kodeforest.net/html/uoe/our-teacher.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 May 2018 08:07:06 GMT -->
</html>
