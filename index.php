...
//registration here.........student..................
   ...
   if (isset($_POST['st_signup'])) {  
    ...
    $guardian_phone_no=$_POST["guardian_phone_no"];
   	$sql1="SELECT * FROM student WHERE email='$st_email'";
	$result1=$con->query($sql1);
	
	if ($result1->num_rows > 0) {             //check email address 
		echo "This email is already exist";
		exit;

	}else{
			$sql="INSERT INTO student VALUES ('','$st_email','$st_pass','$father_name','$mother_name','$date_of_birth','$present_address','$permanent_address','$st_mobile','$guardian_name','$guardian_phone_no','')";
...
<?php 
    ...
    if (isset($_POST['st_login'])) {
    	...
    	if (empty($email) || empty($password)) {
	    	...
	    	$log_sql="SELECT * FROM student WHERE st_email='$email' AND st_password='$password' AND approved='$approved'";
			$log_result=$con->query($log_sql);
			$log_row = $log_result->fetch_assoc();
		   	if($log_result->num_rows==1){
		   		$_SESSION['student_data'] = $log_row['id'];
...
<!-- Mirrored from kodeforest.net/html/uoe/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 May 2018 07:58:05 GMT -->
<head>
	<meta charset="utf-8">
                ...
                <form method="post" action="">
                    <div class="form">
                        <!-- <div class="input-container">
                            <input type="text" placeholder="st_name" name="st_email">
                            <i class="fa fa-user"></i>
                        </div> -->
                        <div class="input-container">
                            <input type="text" placeholder="st_email" name="st_email">
                            <i class="fa fa-envelope-o"></i>
                        </div>
                        <div class="input-container">
                            <input type="password" placeholder="st_Password" name="st_password">
                            <i class="fa fa-unlock"></i>
                        </div>
                        <div class="input-container">
                            <input type="text" placeholder="father_name" name="father_name">
                        </div>
                        <div class="input-container">
                            <input type="text" placeholder="mother_name" name="mother_name">
                        </div>
                        <div class="input-container">
                            <input type="text" placeholder="date_of_birth" name="date_of_birth">
                        </div>
                       <div class="input-container">
                            <input type="text" placeholder="present_address" name="present_address">
                        </div> 
                       <div class="input-container">
                            <input type="text" placeholder="permanent_address" name="permanent_address">
                        </div> 
                        <div class="input-container">
                            <input type="text" placeholder="student mobile" name="st_mobile">
                        </div>
                        <div class="input-container">
                            <input type="text" placeholder="guardian_name" name="guardian_name">
                        </div>
                        <div class="input-container">
                            <input type="text" placeholder="guardian_phone_no" name="guardian_phone_no">
                        </div> 
                        <!-- <div class="input-container">
                            <label>
                                <span class="radio">
                        ...
                        <div class="input-container">
                            <button class="btn-style" name="st_signup">Sign Up</button>
                        </div>
                </form>  
                    </div>
                    <!--FORM FIELD END-->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="">
                    <div class="form">
                        <div class="input-container">
                            <input type="text" placeholder="E-mail" name="st_email">
                            <i class="fa fa-envelope-o"></i>
                        </div>
                        <div class="input-container">
                        ...
                        <div class="input-container">
                            <button class="btn-style" name="st_login">Sign In</button>
                        </div>
                </form>
                    </div>
                    <!--FORM FIELD END-->
                                            ...
                                            <div class="col-md-4">
                                                <div class="edu2_cur_wrap">
                                                    ...
                                                    <div class="edu2_cur_des">
                                                        <span>$20</span>
                                                        <h5><a href="#"><?php echo $row_for_course['title'];?></a></h5>
                                                        <strong>
...
<!-- Mirrored from kodeforest.net/html/uoe/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 May 2018 08:01:24 GMT -->
</html>
